...
<section>
    <div class="container-fluid contRS">
        <div class="row justify-content-center ContenedorRedes">
            ...
            <!-- Redes Sociales -->
            <div class="col-2 col-md-1 d-flex justify-content-center align-items-center redsocial1 mb-3">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 contDatos mb-4 mb-md-0">
                ...
                <p class="informacion" itemscope itemtype="https://schema.org/PostalAddress">
                    ...
                    <strong>País: Ecuador</strong><br>
                    <a href="https://www.google.com/maps/search/?api=1&query=Juan+Carlos+Lavalle+N9-461,+Quito,+Ecuador" target="_blank">
